...
// pub async fn GetHideoutType(client: &Client, id: i64) -> Result<HideoutType, RpelError> {
...
// pub async fn GetHideoutTypeList(client: &Client, id: i64) -> Result<HideoutTypeList, RpelError> {
// // let client = client.get().await?;
